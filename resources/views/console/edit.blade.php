            ...
            <div class="col-12 col-md-6">
                <form action="{{ route('console.update', $console) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        {{-- //!Questa è la ManyToMany in quanto il game ha traversato il modello console --}}
                        @foreach ($games as $game)
                            <input class="form-check-input" name="games[]" type="checkbox" value="{{ $game->id }}"
                                id="{{ $game->id }}" @if ($console->games->contains($game->id)) checked @endif>
